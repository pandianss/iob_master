...
exports.GovernanceModule = GovernanceModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [governance_service_1.GovernanceService, doa_service_1.DoAService, prisma_service_1.PrismaService],
        exports: [governance_service_1.GovernanceService, doa_service_1.DoAService],
    })
], GovernanceModule);
