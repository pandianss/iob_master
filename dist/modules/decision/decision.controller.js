...
let DecisionController = class DecisionController {
    ...
    async create(body) {
        return this.decisionService.create(body.initiatorPostingId, body.data, body.deptContextId, body.regionContextId, body.decisionTypeId, body.functionalScopeId);
    }
